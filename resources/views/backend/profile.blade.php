                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::password('password', ["class"=>"form-control form-control-sm","placeholder"=>trans('backend/users.password'),"id"=>"password","name"=>"password","maxlength" => "30","minlength" => "8"]) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::password('confirm_password', ["class"=>"form-control form-control-sm", "placeholder"=>trans('backend/users.confirm_password'), "id"=>"confirm_password","maxlength" => "30","minlength" => "8"]) }}
                                        </div>
                                    </div>
                                </div>
