        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview {{(Request::is("$backend/profile")) ? 'menu-open' : ''}}">
                ...
                <ul class="nav nav-treeview {{(Request::is("$backend/profile")) ? '' : 'display_none'}}">
                    <li class="nav-item">
                        <a href="{{route('admin.profile')}}" class="nav-link {{(Request::is("$backend/profile")) ? 'active' : ''}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{(Request::is("$backend", "$backend/404", "$backend/403", "$backend/500")) ? 'active' : ''}}" href="{{route('admin.home')}}">
            ...
            <li class="nav-item has-treeview {{(Request::is("$backend/users","$backend/users/*","$backend/roles","$backend/roles/*","$backend/branch","$backend/branch/*")) ? 'menu-open' : ''}}">
                <a class="nav-link {{(Request::is("$backend/users","$backend/users/*","$backend/roles","$backend/roles/*","$backend/branch","$backend/branch/*")) ? 'active' : ''}}">
                    ...
                    <p> {{trans('backend/common.master_data')}}</p>
                    <i class="right fas fa-angle-left"></i>
                </a>
                <ul class="nav nav-treeview">
                    @if($permission::checkActionPermission('view_roles'))
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/roles","$backend/roles/*")) ? 'active' : ''}}" href="{{route('admin.roles.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/users","$backend/users/*")) ? 'active' : ''}}" href="{{route('admin.users.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/branch","$backend/branch/*")) ? 'active' : ''}}" href="{{route('admin.branch.index')}}">
            ...
            <li class="nav-item has-treeview {{(Request::is("$backend/product","$backend/product/*","$backend/category_attribute","$backend/category_attribute/*","$backend/attributes","$backend/attributes/*","$backend/modifier","$backend/modifier/*","$backend/product_inventory","$backend/product_inventory/*","$backend/setmeal","$backend/setmeal/*")) ? 'menu-open' : ''}}">
                <a class="nav-link {{(Request::is("$backend/product","$backend/product/*","$backend/category_attribute","$backend/category_attribute/*","$backend/attributes","$backend/attributes/*","$backend/modifier","$backend/modifier/*","$backend/product_inventory","$backend/product_inventory/*","$backend/setmeal","$backend/setmeal/*")) ? 'active' : ''}}">
                    ...
                    <p> {{trans('backend/common.product_master')}}</p>
                    <i class="right fas fa-angle-left"></i>
                </a>
                <ul class="nav nav-treeview">
                    @if($permission::checkActionPermission('view_product'))
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/product","$backend/product/*")) ? 'active' : ''}}" href="{{route('admin.product.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/category","$backend/category/*")) ? 'active' : ''}}" href="{{route('admin.category.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/category_attribute","$backend/category_attribute/*")) ? 'active' : ''}}" href="{{route('admin.category_attribute.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/attributes","$backend/attributes/*")) ? 'active' : ''}}" href="{{route('admin.attributes.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/modifier","$backend/modifier/*")) ? 'active' : ''}}" href="{{route('admin.modifier.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/product_inventory","$backend/product_inventory/*")) ? 'active' : ''}}" href="{{route('admin.product_inventory.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/setmeal","$backend/setmeal/*")) ? 'active' : ''}}" href="{{route('admin.setmeal.index')}}">
            ...
            "$backend/payment-type","$backend/payment-type/*")) ? 'menu-open' : ''}}">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/table","$backend/table/*")) ? 'active' : ''}}" href="{{route('admin.table.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/voucher","$backend/voucher/*")) ? 'active' : ''}}" href="{{route('admin.voucher.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/terminal","$backend/terminal/*")) ? 'active' : ''}}" href="{{route('admin.terminal.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/banner","$backend/banner/*")) ? 'active' : ''}}" href="{{route('admin.banner.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/tax","$backend/tax/*")) ? 'active' : ''}}" href="{{route('admin.tax.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/payment-type","$backend/payment-type/*")) ? 'active' : ''}}" href="{{route('admin.payment-type.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/logs","$backend/logs/*")) ? 'active' : ''}}" href="{{route('admin.logs.index')}}">
                            <i class="nav-icon fas fa fa-history"></i>
                    ...
                    <li class="nav-item has-treeview  {{(Request::is("$backend/country","$backend/country/*","$backend/state","$backend/state/*","$backend/city","$backend/city/*")) ? 'menu-open' : ''}}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{(Request::is("$backend/city","$backend/city/*")) ? 'active' : ''}}" href="{{ route('admin.city.index') }}">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{(Request::is("$backend/state","$backend/state/*")) ? 'active' : ''}}" href="{{ route('admin.state.index') }}"><i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{(Request::is("$backend/country","$backend/country/*")) ? 'active' : ''}}" href="{{ route('admin.country.index') }}">
                                    <i class="far fa-circle nav-icon"></i>
            ...
            "$backend/box","$backend/box/*")) ? 'menu-open' : ''}}">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/wine_store_management","$backend/wine_store_management/*")) ? 'active' : ''}}" href="{{route('admin.wine_store_management.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/rac","$backend/rac/*")) ? 'active' : ''}}" href="{{route('admin.rac.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is("$backend/box","$backend/box/*")) ? 'active' : ''}}" href="{{route('admin.box.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{(Request::is("$backend/attendance","$backend/attendance/*")) ? 'active' : ''}}" href="{{route('admin.attendance.index')}}">
