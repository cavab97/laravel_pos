...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview {{ isRequest('admin.profile') ? 'menu-open' : ''}}">
                <a href="#" class="nav-link custom-user-panel-nav-link px-0">
                    <div class="custom-user-panel user-panel">
                        <div class="image">
                            <img src="{{asset('backend/dist/img/user2-160x160.jpg')}}" class="img-circle elevation-2" alt="{{$userData->name}}">
                        </div>
                        <div class="info">
                            <p>{{$userData->name}}
                ...
                <ul class="nav nav-treeview {{ isRequest('admin.profile') ? '' : 'display_none'}}">
                    <li class="nav-item">
                        <a href="{{route('admin.profile')}}" class="nav-link {{ isRequest('admin.profile') ? 'active' : ''}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is(getPath('admin.home')) ? 'active' : ''}}" href="{{route('admin.home')}}">
            ...
            <li class="nav-item has-treeview {{
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.roles.index') ? 'active' : ''}}" href="{{route('admin.roles.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.users.index') ? 'active' : ''}}" href="{{route('admin.users.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.branch.index') ? 'active' : ''}}" href="{{route('admin.branch.index')}}">
            ...
            <li class="nav-item has-treeview {{
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.product.index') ? 'active' : ''}}" href="{{route('admin.product.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.category.index') ? 'active' : ''}}" href="{{route('admin.category.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.category_attribute.index') ? 'active' : ''}}" href="{{route('admin.category_attribute.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.attributes.index') ? 'active' : ''}}" href="{{route('admin.attributes.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.modifier.index') ? 'active' : ''}}" href="{{route('admin.modifier.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.product_inventory.index') ? 'active' : ''}}" href="{{route('admin.product_inventory.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.setmeal.index') ? 'active' : ''}}" href="{{route('admin.setmeal.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.price_type.index') ? 'active' : ''}}" href="{{route('admin.price_type.index')}}">
                            <i class="nav-icon fas fa fa-product-hunt"></i>
            ...
            <li class="nav-item">
                <a class="nav-link {{(Request::is($backend.'/customer',$backend.'/customer/*')) ? 'active' : ''}}" href="{{route('admin.customer.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{(Request::is($backend.'/order',$backend.'/order/*')) ? 'active' : ''}}" href="{{route('admin.order.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{(Request::is($backend.'/setting',$backend.'/setting/*')) ? 'active' : ''}}" href="{{route('admin.setting.index')}}">
            ...
            <li class="nav-item has-treeview {{
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.printer.index') ? 'active' : ''}}" href="{{route('admin.printer.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.table.index') ? 'active' : ''}}" href="{{route('admin.table.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.table-color.index') ? 'active' : ''}}" href="{{route('admin.table-color.index')}}">
                            <i class="nav-icon fas fa fa-table"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.kitchen.index') ? 'active' : ''}}" href="{{route('admin.kitchen.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.voucher.index') ? 'active' : ''}}" href="{{route('admin.voucher.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.terminal.index') ? 'active' : ''}}" href="{{route('admin.terminal.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.banner.index') ? 'active' : ''}}" href="{{route('admin.banner.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.tax.index') ? 'active' : ''}}" href="{{route('admin.tax.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.payment-type.index') ? 'active' : ''}}" href="{{route('admin.payment-type.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.logs.index') ? 'active' : ''}}" href="{{route('admin.logs.index')}}">
                            <i class="nav-icon fas fa fa-history"></i>
                            <p>{{trans('backend/logs.logs')}}</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.logs.pos-logs') ? 'active' : ''}}" href="{{route('admin.logs.pos-logs')}}">
                            <i class="nav-icon fas fa fa-history"></i>
                    ...
                    <li class="nav-item has-treeview  {{
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ isRequest('admin.country.index') ? 'active' : ''}}" href="{{ route('admin.city.index') }}">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ isRequest('admin.country.index') ? 'active' : ''}}" href="{{ route('admin.state.index') }}"><i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ isRequest('admin.country.index') ? 'active' : ''}}" href="{{ route('admin.country.index') }}">
                                    <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item has-treeview {{
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.wine_store_management.index') ? 'active' : ''}}" href="{{route('admin.wine_store_management.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.rac.index') ? 'active' : ''}}" href="{{route('admin.rac.index')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.box.index') ? 'active' : ''}}" href="{{route('admin.box.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ isRequest('admin.attendance.index') ? 'active' : ''}}" href="{{route('admin.attendance.index')}}">
            ...
            <li class="nav-item has-treeview {{
                ...
                <ul class="nav nav-treeview">
                   <!--  @if($permission::checkActionPermission('view_category_reports'))
                    ...
                    @endif
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.reports.cancelled.index') ? 'active' : ''}}" href="{{route('admin.reports.cancelled.index')}}">
                            <i class="nav-icon fas fa fa-user-circle"></i>
                            <p>{{trans('backend/common.cancelled_reports')}}</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ isRequest('admin.reports.payment.index') ? 'active' : ''}}" href="{{route('admin.reports.payment.index')}}">
                            <i class="nav-icon fas fa fa-user-circle"></i>
