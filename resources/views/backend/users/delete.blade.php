<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel15"> {{trans('backend/users.delete_user')}}</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
            </button>
        </div>

            {!! Form::model(null, ['route' => ['admin.users.destroy', $uuid], 'method' => 'delete', 'files' => false, 'class' => 'validate', 'id' => 'frmUser', 'role' => 'form']) !!}
            <div class="modal-body">
                <div>{{trans('backend/users.delete_user_msg')}}</div>
            </div>
