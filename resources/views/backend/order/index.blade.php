    ...
    $(function() {
        ...
        var oTable = $('#order-list').dataTable({
            ...
            "fnServerParams": function(aoData) {
                ...
                aoData.push({
                    name: 'from_date',
                    value: $('[name="from_date"]').val()
                });
                aoData.push({
                    name: 'to_date',
                    value: $('[name="to_date"]').val()
                });
                aoData.push({
                    name: 'payment_id',
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mt-2">
                                <input type="text" id="invoice_no" name="invoice_no" class="form-control form-control-sm" placeholder="{{trans('backend/order.invoice_no')}}" onkeyup="pressEnter(event)">
                            </div>
                            <div class="col-md-3 mt-2">
                            ...
                            <div class="col-md-3 mt-2 select2-purple">
                                <select name="payment_id[]" id="payment_id" multiple class="form-control form-control-sm select2 js-example-basic-multiple js-states" data-placeholder="{{trans('backend/reports.select_payment')}}" required>
