...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel15"> {{trans('backend/country.delete')}}</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
            </button>
        </div>
        {!! Form::model(null, ['route' => ['admin.country.destroy', $id], 'method' => 'delete', 'files' => false, 'class' => 'validate', 'id' => 'frmCountry', 'role' => 'form']) !!}
        <div class="modal-body">
            <div>{{trans('backend/country.delete_confirm')}}</div>
            <div class="row">
                <div class="col-md-12">
