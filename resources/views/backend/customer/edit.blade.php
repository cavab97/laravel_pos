            ...
            <div class="card card-secondary">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a href="#basicInfo" data-toggle="tab" class="nav-link active">{{trans('backend/customer.customer_details')}}</a></li>
                        <li class="nav-item disabled"><a href="#addressArea" data-toggle="tab" class="nav-link">{{trans('backend/customer.customer_address')}}</a></li>
                    </ul>
            ...
            {{--<div class="row">
                <div class="col-12">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fa fa-edit"></i> {{trans('backend/customer.edit_customer')}}</h3>
                        </div>
                        <div class="card-body">
                            @include('backend.customer.form')
                        </div>
